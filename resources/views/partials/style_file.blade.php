...
<link rel="stylesheet" type="text/css" href="{{ asset('assets_2/vendors/slick-carousel/slick.css') }}">
<link rel="stylesheet" href="{{ asset('assets/plugins/image-puzzle-slider-captcha/disk/slidercaptcha.min.css') }}">
<link href="{{ asset('assets_2/vendors/ace-responsive-menu/ace-responsive-menu.css') }}" rel="stylesheet" type="text/css" />
