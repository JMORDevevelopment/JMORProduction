...
<div class="home_banner">
    <div class="img">
        <img class="img-fluid" src="{{ asset('/as') }}">
    </div>
</div>
            ...
            <div class="col-md-6">
                ...
                <div class="gallery">
                    {{-- Legacy Instagram feed fetch was disabled ($live_C = false) in the original
                         ...
                         re-enabled, it should be implemented as a scheduled job or controller
                         method that caches results, rather than a live cURL call inside the view. --}}
                </div>
