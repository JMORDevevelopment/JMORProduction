            ...
            <div class="row justify-content-md-center align-items-center text-white py-4 py-lg-5">
                <div class="col-md-7">
                    <div class="text-center">
                        <h1 class="display-sm-4 display-lg-3">{{ $news_datas['name'] }}</h1>
                    </div>
                </div>
            </div>
        </div>
        ...
        <section class="wt-section">
            <div class="container">
                <div class="row justify-content-between">
                    <div class="col-lg-8">
                        <div class="news-post">
                            <a href="{{ route('news.detail', $news_datas['link']) }}">
                                <img class="rounded mb-lg-4 mb-3 img-fluid" src="{{ asset($news_datas['image']) }}" alt="card image">
                            </a>
                            <div class="meta font-lora mb-3">
                                <a href="#">Post Date</a>
                                <a href="#">{{ date('m-d-Y', strtotime($news_datas['published'])) }}</a>
                            </div>
                        </div>
                        <p>{!! \App\Support\RichText::sanitize($news_datas['description']) !!}</p>
                    </div>
                    <div class="col-lg-4">
