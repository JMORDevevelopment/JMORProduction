                ...
                <div class="row justify-content-between">
                    <div class="col-lg-8">
                        @if(!empty($page_datas['image']))
                            <a href="#">
                                <img class="rounded mb-lg-4 mb-3 img-fluid" src="{{ asset($page_datas['image']) }}" alt="card image">
                            </a>
                        @endif
                        <div class="blog-post">
                    ...
                    <div class="col-lg-4">
                        <div class="jmor_radio-widget mb-4">
                            ...
                            @php $latestBlogs = \App\Models\Blog::orderBy('id', 'desc')->limit(5)->get(); @endphp
                            @foreach($latestBlogs as $latestPost)
                                <div class="card border-0 bg-light mb-1">
                                    <div class="card-body row align-items-center">
                                        <div class="col-12">
                                            <h6 class="my-2 font-size-14">
                                                <a href="{{ route('blog.detail', Str::after($latestPost->link, 'blog/')) }}">{{ $latestPost->name }}</a>
                                            </h6>
