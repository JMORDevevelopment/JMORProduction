            ...
            <div class="row justify-content-md-center align-items-center text-white py-4 py-lg-5">
                <div class="col-md-7">
                    <div class="text-center">
                        <h1 class="display-sm-4 display-lg-3">{{ $press_releases_datas['name'] }}</h1>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="row justify-content-between">
                    <div class="col-lg-8">
                        <div class="case_studies-post">
                            <a href="{{ route('press-releases.detail', $press_releases_datas['link']) }}">
                                <img class="rounded mb-lg-4 mb-3 img-fluid" src="{{ asset($press_releases_datas['image']) }}" alt="card image">
                            </a>
                            ...
                            @foreach($latestPosts as $latestPost)
                                <div class="card border-0 bg-light mb-1">
                                    <div class="card-body row align-items-center">
                                        <div class="col-12">
                                            <h6 class="my-2 font-size-14"><a href="{{ route('press-releases.detail', $latestPost->link) }}">{{ $latestPost->name }}</a></h6>
