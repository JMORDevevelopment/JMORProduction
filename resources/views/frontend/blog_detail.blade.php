            ...
            <div class="row justify-content-md-center align-items-center text-white py-4 py-lg-5">
                <div class="col-md-7">
                    <div class="text-center">
                        <h1 class="display-sm-4 display-lg-3">{{ $blog_datas['name'] }}</h1>
                    </div>
                </div>
            </div>
        </div>
        ...
        <section class="wt-section">
            <div class="container">
                <div class="row justify-content-between">
                    <div class="col-lg-8">
                        <div class="blog-post">
                            <a href="{{ route('blog.detail', Str::after($blog_datas['link'], 'blog/')) }}">
                                @if(!empty($blog_datas['image']))
                                    <img class="rounded mb-lg-4 mb-3" src="{{ asset($blog_datas['image']) }}" height="300px" alt="card image">
                                @endif
                            </a>
