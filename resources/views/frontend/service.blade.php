                    ...
                    @foreach($services as $service)
                        <div class="col-lg-3 mb-4 mb-lg-0">
                            <div class="display-3 text-primary mb-2">
                                <div class="mb-3" style="height:150px;"><img src="{{ asset($service->image) }}" alt=""></div>
                            </div>
                            <a href="{{ route('service.detail', $service->link) }}" style="color:#0053a0; text-align:center;"><h4 class="h5">{{ $service->title }}</h4></a>
                        </div>
                    @endforeach
                </div>
            </div>
