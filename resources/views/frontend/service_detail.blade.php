            ...
            <div class="row justify-content-md-center align-items-center text-white py-4 py-lg-5">
                <div class="col-md-7">
                    <div class="text-center">
                        <h1 class="display-sm-4 display-lg-3">{{ $service_datas['title'] }}</h1>
                    </div>
                </div>
            </div>
        </div>
                            ...
                            @foreach($latestPosts as $latestPost)
                                <div class="card border-0 bg-light mb-1">
                                    <div class="card-body row align-items-center">
                                        <div class="col-4">
                                            <a href="{{ route('blog.detail', Str::after($latestPost->link, 'blog/')) }}">
                                                <img class="card-img" src="{{ asset($latestPost->image) }}" alt="card image">
                                            </a>
                                        </div>
                                        <div class="col-8">
