            ...
            <div class="row justify-content-md-center align-items-center text-white py-4 py-lg-5">
                <div class="col-md-7">
                    <div class="text-center">
                        <h1 class="display-sm-4 display-lg-3">Media Resources</h1>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="col-lg-8">
                        @foreach($posts as $post)
                            <div class="jmor_radio-post">
                                <a href="{{ route('media-resources.detail', $post->link) }}">
                                    <img class="rounded mb-lg-4 mb-3 img-fluid" src="{{ asset($post->image) }}" alt="card image">
                                </a>
                                <h3><a href="{{ route('media-resources.detail', $post->link) }}">{{ $post->name }}</a></h3>
