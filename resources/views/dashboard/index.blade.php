		...
		<div class="row">
			...
			<div class="col-lg-4 col-xs-6">
				...
				<div class="small-box bg-green">
					...
					<a href="{{ route('dashboard.orders') }}" class="small-box-footer">More <i class="fa fa-arrow-circle-right"></i></a>
				</div>
			</div>
					...
					<div class="box-body">
						...
						<tbody>
							...
							<tr>   <td>{{ $nation->order_id + 10000 }}</td>
								...
								<td>
									<div class="tools">
										<a href="{{ route('dashboard.order_invoice', $nation->order_id) }}" class="btn btn-primary" ><i class="fa fa-edit"></i></a>
									</div>
								</td>
							</tr>
							@endforeach
