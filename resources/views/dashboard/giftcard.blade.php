        ...
        <section class="content">
            <div class="box">
                <div class="box-header">
                    <h3 class="box-title">Giftcard order Data</h3>
                </div>
                <!-- /.box-header -->
                <div class="box-body">
                        ...
                        <tbody>
                            @forelse($transactions as $trans_data)
                                <tr>
                                    ...
                                    <td>
                                        <div class="tools">
                                            <a href="{{ route('dashboard.giftcard_invoice', $trans_data->order_id) }}" class="btn btn-primary" title="Invoice"><i class="fa fa-edit"></i></a>
                                        </div>
                                    </td>
                                </tr>
                            @empty
