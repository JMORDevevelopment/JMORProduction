...
use App\Filament\Admin\Resources\BrandGuidelineResource\Pages;
...
class BrandGuidelineResource extends Resource
{
                ...
                Schemas\Components\Section::make('Content')
                    ->schema([
                        ...
                        Forms\Components\FileUpload::make('image')
                            ->label('Image')
                            ->image()
                            ->directory('uploads/brand_guidelines')
                            ->visibility('public')
    ...
    {
        return [
            'index' => Pages\ListBrandGuidelines::route('/'),
            'create' => Pages\CreateBrandGuideline::route('/create'),
            'edit' => Pages\EditBrandGuideline::route('/{record}/edit'),
        ];
    }
}
